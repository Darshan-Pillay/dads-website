  ...
  return (
    <section className="section section--center" id="contact">
      <div className="container">
        ...
        <h2 className="section__title reveal" style={{ '--d': '80ms', maxWidth: '24ch', marginInline: 'auto' }}>
          Independent advice for your next technology decision.
        </h2>
        ...
        <form className="contact__card contact__form reveal" style={{ '--d': '140ms' }}
          ...
          <Select label="What do you need help with?" name="domain" placeholder="Choose a technology area"
            options={['SAP', 'Microsoft', 'Oracle', 'IBM', 'AI & Data', 'Cloud', 'Big Data & Analytics', 'Blockchain', 'Mobile', 'Not sure yet']} />
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="container site-footer__base">
        <span>© 2026 Softfinity Consulting (Pty) Ltd. Independent IT consultancy.</span>
