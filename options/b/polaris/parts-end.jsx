...
function Footer() {
  const cols = [
    { h: 'Services', items: ['SAP', 'Microsoft', 'Oracle', 'IBM', 'AI', 'Cloud', 'Big Data', 'Blockchain', 'Mobile'] },
    { h: 'Company', items: ['Who we are', 'Principles', 'Industries', 'How we work', 'Contact'] },
    { h: 'Connect', items: ['Email', 'LinkedIn', 'Insights'] },
  ];
  return (
